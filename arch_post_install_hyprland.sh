...
sudo pacman -S --noconfirm adw-gtk-theme baobab bash-completion btop btrfs-assistant cava decibels dosfstools fd ffmpeg ffmpeg4.4 file-roller fzf gcc github-cli gnome-calculator gnome-disk-utility gnome-keyring gst-libav gvfs gvfs-google gvfs-gphoto2 gvfs-nfs gvfs-wsdd gvfs-smb kimageformats libappindicator libgsf libreoffice-fresh-en-gb loupe man-db micro nautilus ntfs-3g obsidian papers papirus-icon-theme power-profiles-daemon qt5ct qt6ct ripgrep showtime snapshot starship sushi wl-clipboard xdg-user-dirs xdg-utils
...
sudo pacman -R --noconfirm dolphin nano vim network-manager-applet ly htop chromium

# install DankMaterialShell for Hyprland:
